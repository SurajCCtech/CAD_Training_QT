	...
	: QMainWindow(parent)
{
	...
	connect(ui.Quit_Button, &QPushButton::clicked, this, &DCAD::close);
	...
	/* connect(openglWindow, &OpenGLWindow::lineCreated, this, [model](const QString& name)
		 ...
		 //connect(treeView->selectionModel(), &QItemSelectionModel::selectionChanged, this, &DCAD::onSelectionChanged);
